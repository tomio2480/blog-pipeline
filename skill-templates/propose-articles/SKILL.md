...
本ファイルは Public リポジトリの **ひな形** である．利用者は個人化版を Private リポジトリの `.claude/skills/propose-articles/SKILL.md` へコピーする．固有名詞辞書との連携や Issue テンプレートを差し込む前提とする．
...
- クラスタリング結果の自動公開．クラスタ結果はメイン会話へ返し，候補ファイルとして `proposals/candidates/` に保存するまでに留める
